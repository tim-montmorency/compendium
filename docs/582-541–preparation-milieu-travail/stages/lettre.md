...
## Description
Vous devez écrire une lettre de présentation pour une compagnie existante. Il est reccommandé de sélectionner une compagnie pour laquelle vous comptez appliquer pour votre stage. Cette liste pourra vous aider à faire votre choix: 
...
!!! warning "Attention"
    ...
    L'utilisation d'une intelligence artificielle est permise. Cependant, votre lettre doit bien vous représenter, faites donc attention à la justesse de votre demande. Si vous utilisez une IA, vous devez remettre des captures écrans de votre discussion avec cette dernière.  
...
* **5 novembre**: Remise de la lettre pour les étudiants de Lora
...
| **Deuxième paragraphe (et troisième si nécessaire)** | **20** | Le deuxième paragraphe met en valeur vos compétences et vos connaissances qui seront utiles pour l'entreprise pour laquelle vous appliquez. Vous expliquez bien ce que vous pouvez apporter à l'entreprise en tant que stagiaire. Vos atouts sont nommés et vous prouvez comment ils peuvent être utiles à votre équipe de travail. | Le deuxième paragraphe met en valeur vos compétences et vos connaissances sans qu'ils soient appliqués à l'entreprise concernée. Vous expliquez ce que vous pouvez apporter à l'entreprise en tant que stagiaire. Vos atouts sont nommés. | Le deuxième paragraphe parle de certaines de vos compétences et vos connaissances. Vos atouts sont nommés. | Élément absent |
| **Dernier paragraphe** | **10** | Le paragraphe indique clairement que vous êtes prêt à passer une entrevue ou faire les démarches suivantes. Vous terminez le paragraphe par une formule de politesse appropriée. | Le paragraphe indique que vous êtes prêt à passer une entrevue. Vous terminez le paragraphe par une formule de politesse. | Un des deux éléments est manquant. | Élément absent |
| **Rédaction** | **15** | La lettre est bien écrite, elle est simple et les tournures de phrase sont positives. La lettre est honnête et vous met bien en valeur. Votre contenu est personnalisé. Le contenu des paragraphes est pertinent et nécessaire. | La rédaction de la lettre est bien, mais elle pourrait être un peu retravaillée. | La rédaction de la lettre manque de peaufinage. | Élément absent |
| **Mise en page** | **15** | La lettre est signée, l'en-tête a une bonne mise en page. La police est simple et efficace, la mise en page est épurée (interligne!). Les paragraphes sont bien séparés. | La mise en page est bien, mais certaines sections sont à retravailler. | La mise en page est à retravailler pour une meilleure lisibilité. | Élément absent |
| **Identité visuelle** | **5** | La lettre contient un clin d'œil à votre identité visuelle. Cet ajout n'alourdit pas le tout. | La lettre reflète votre identité visuelle, trop subtilement ou trop intensément. | La lettre pourrait mieux refléter votre identité visuelle. | Élément absent |
| **Qualité du français** | **10** | La lettre contient peu ou pas de fautes. | La lettre contient quelques fautes. | L'orthographe de la lettre est à retravailler. | La lettre a plusieurs problèmes de syntaxe et d'orthographe, elle aurait besoin de révision. |
| **TOTAL** | **100** | | | | |
