# :material-animation-play: Animation CSS :material-heart:{ .animate }
...
<p class="codepen" data-theme-id="50210" data-height="650" data-pen-title="DEMO animation css au scoll timeline, trigger, stagger etc" data-version="2" data-default-tab="result" data-slug-hash="VYKovOO" data-user="tim-momo" style="height: 650px; box-sizing: border-box; display: flex; align-items: center; justify-content: center; border: 2px solid; margin: 1em 0; padding: 1em;">
