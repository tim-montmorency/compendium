...
[📄 Plan de cours (mis à jour le 29 mars) :material-download:](https://cmontmorency365-my.sharepoint.com/:b:/g/personal/mariem_ouellet_cmontmorency_qc_ca/IQDTIATHK-79TJaZEiQhMukbASV3gvYqLQNSOtjosfZgHU4?e=Gtxp3O){ .md-button .md-button--primary }
...
Setup :
  •	Ouvrir VS Code devant les étudiants
  •	Avoir ChatGPT/Claude ouvert dans un autre onglet

Action :
  1.	Prompt à l'IA :
  "Crée-moi une navbar responsive en HTML et CSS avec un logo à gauche et 4 liens de navigation à droite"
  2.	Copier le code généré dans VS Code
  3.	Créer un fichier navbar-ia.html
  4.	Ouvrir dans le navigateur → ça fonctionne!

-->
> <br>
> "L'IA a généré quelque chose qui fonctionne. Vous, vous créez quelque chose qui fonctionne bien et durablement."
> <br>.
