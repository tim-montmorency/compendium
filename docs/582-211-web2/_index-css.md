...
<!--
 ...
 TODO pour 2027 Créer une bibliothèque des propriétés CSS avec icones et liens vers pages explicative (ou section d'un page) 
 ...
 exemples 
 https://fonts.google.com/icons?icon.query=row&icon.size=24&icon.color=%231f1f1f 
 https://fonts.google.com/icons?icon.query=css&icon.size=24&icon.color=%231f1f1f
