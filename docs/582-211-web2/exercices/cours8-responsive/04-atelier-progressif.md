...
<body>
  <div class="grid">
    <div class="card"><h3>Projet 1</h3><p>Description courte du projet multimédia réalisé durant la session.</p></div>
    <div class="card"><h3>Projet 2</h3><p>Description courte du projet multimédia réalisé durant la session.</p></div>
    <div class="card"><h3>Projet 3</h3><p>Description courte du projet multimédia réalisé durant la session.</p></div>
    <div class="card"><h3>Projet 4</h3><p>Description courte du projet multimédia réalisé durant la session.</p></div>
    <div class="card"><h3>Projet 5</h3><p>Description courte du projet multimédia réalisé durant la session.</p></div>
    <div class="card"><h3>Projet 6</h3><p>Description courte du projet multimédia réalisé durant la session.</p></div>
  </div>
</body>
</html>
```
...
<body>
  <section class="hero">
    <div class="hero__content">
      <span class="hero__label">Nouveauté 2026</span>
      <h1 class="hero__title">Créer des interfaces qui s'adaptent vraiment</h1>
      <p class="hero__desc">
...
| `.hero__title` font-size | `clamp(1.75rem, 5vw, 1.75rem)` | `clamp(1.75rem, 4vw, 3rem)` |
| `.hero__visual` hauteur | 200px | Hauteur de la section |
| `.hero__visual` background | `#1a1a2e` | `#1a1a2e` |
| Boutons | empilés (colonne) | côte à côte (rangée) |
| Padding `.hero__content` | `2rem` | `4rem` |
