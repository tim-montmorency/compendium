+ TODO CHANGER POUR UN CHOIX PARMI: 

+ Wellness clinic (clinique bien-être) < 
...
+ Yoga Studio (studio de yoga) REJETÉ (car je devais faire des choix)
+ Photo studio (studio photo) REJETÉ (car je devais faire des choix)
+ Community center (centre communautaire) REJETÉ (car je devais faire des choix)