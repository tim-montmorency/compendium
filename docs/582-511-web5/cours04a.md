...
!!! danger "📱 Téléphones cellulaire en classe"
    Il est dorénavent obligatoire de conserver son téléphone📱 hors de votre portée d'attention, sinon vous devrez le laisser dans la boite prévue à cet effet. C'est une résolution de département et nous devons suivre la procédure pour toutes les classes. Aucune exception.
