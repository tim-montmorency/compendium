...
<div class="proj-block">
  ...
  <div class="proj-tech-grid">
    ...
    <div class="proj-tech-tile"><svg width="17" height="17" viewBox="0 0 24 24" fill="none" stroke="var(--proj-teal)" stroke-width="1.7"><rect x="3" y="6" width="18" height="12" rx="2"/><path d="M8 6V4h8v2M3 11h18"/></svg><div class="proj-tech-name">Interactivité</div><div class="proj-tech-desc">Un composant Vue.js de votre choix.</div></div>
...
<div class="proj-stat-block" style="margin-bottom:32px;">
  ...
  <p>de la note finale du cours Web 5, évalué de façon <strong>individuelle</strong> (100% de la note est individuelle). Les critères détaillés seront présentés en classe dès le début du projet.</p>
</div>
