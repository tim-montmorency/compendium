...
| --- | ------------- | ---- | ----- |
| Alexis Guilbault | Mardi<br>12h30&nbsp;à&nbsp;14h10 | En personne au Centre d’aide C-1612 | 3 février au 27 avril inclus. |
| Olivier Laliberté | Mercredi<br>19h00&nbsp;à&nbsp;20h15 | En ligne sur TEAMS : canal Tutorat de l'équipe TIM-Programme TIM | 4 février au 29 avril inclus. |
| Iryna Lysenko | Dimanche<br>18h00&nbsp;à&nbsp;19h15 | En ligne sur TEAMS : canal Tutorat de l'équipe TIM-Programme TIM | 8 février au 3 mai inclus. |
...
![](./assets/img/banner-fonts.webp){.w-100}
...
![](./assets/img/fonte-def.png){data-zoom-image}
...
![](./assets/img/fonte-graisse.png){data-zoom-image}
...
![](./assets/img/fonte-serif.png){data-zoom-image}
...
![](./assets/img/fonte-sans-serif.png){data-zoom-image}
...
![](./assets/img/typography_slab_serif.jpg){data-zoom-image}
...
![](./assets/img/fonte-monospace.png){data-zoom-image}
...
![](./assets/img/fonte-cursive.png){data-zoom-image}
...
![](./assets/img/different-kinds-of-display-typefaces.png){data-zoom-image}
...
![](./assets/img/fonte-variantes.png){data-zoom-image} 

![](./assets/img/variantes-g.png){data-zoom-image .w-25 .float-right} 
...
![](./assets/img/fonte-ligature.png){data-zoom-image}
...
![](./assets/img/fonte-interlignage.png){data-zoom-image}

Espace entre les lignes. 

### Interlettrage (*tracking* / *letter spacing*)

![](./assets/img/fonte-interlettrage.png){data-zoom-image}

Espacement **global** appliqué à un mot à un texte.

### Crénage (*kerning*)

![](./assets/img/avec-sans-kerning.webp){data-zoom-image}
...
!!! example "Œil de lynx"
    ...
    ![](./assets/img/good-average-bad.jpg){data-zoom-image .w-25}
...
!!! example "Test de connotations"
	...
	![](./assets/img/typeface-game-a.png){data-zoom-image}

	![](./assets/img/typeface-game-b.png){data-zoom-image}
	</div>
...
![](./assets/img/ideal-line-length.webp){data-zoom-image .w-50}
...
<div class="grid grid-1-2" markdown>
  ![](./activite/exercice/method-ac/prev3.webp)
...
<div class="grid grid-1-2" markdown>
  ![](./activite/exercice/method-ac/prev4.webp)
