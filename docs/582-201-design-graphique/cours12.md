...
![](./assets/img/credits-ai.png){.w-10 data-zoom-image}

### retirer un fond uni

![](./assets/img/dyk-remove-bg.png){data-zoom-image}

### retirer un élément spécifique

![](./assets/img/dyk-remove-specific.png){data-zoom-image}

### augmenter la résolution

![](./assets/img/dyk-enhance-rez.png){data-zoom-image}

### ajouter de l'image

![](./assets/img/dyk-expand.png){data-zoom-image}

### vectorizer une image

![](./assets/img/dyk-vectorize.png){data-zoom-image}

## Gif animé

![](./assets/img/bonjour.gif){.w-33}
...
![](./assets/img/anim-page-swipe.webp){data-zoom-image}
...
![](./assets/img/anim-loop.webp){data-zoom-image}
