...
![](./assets/img/Jeremiah-Johnson.webp){.w-100}

<div class="grid grid-1-2" markdown>
  ![](./assets/img/vote.jpeg)
...
![](./assets/img/original-12a53a5997dfa4b25ff98f03f1dc1fcb.webp){.w-100 data-zoom-image}
...
![](./assets/img/publicite-accroche.jpg){data-zoom-image .w-100}

![](./assets/img/heins.jpeg){.w-100 data-zoom-image}

![](./assets/img/6721e41aee57bce80eed2adb_66ec06af342afca247dbddf9_651bc8a90d92ea7de201f89f_Afk5Y93TRq2Je2UYFOKX.jpeg){.w-100 data-zoom-image}

### La proposition de valeur

C'est la réponse à la question : **« en quoi ça me concerne ? »**

![](./assets/img/ww.png){.w-100 data-zoom-image}
![](./assets/img/1696510096830.jpeg){.w-33 data-zoom-image}
![](./assets/img/Untitled-design-69.png){.w-33 data-zoom-image}
...
![](./assets/img/call-to-action-examples-max-14.webp){.w-100 data-zoom-image}

![](./assets/img/Screenshot_2024-10-23_135031.webp){.w-33 data-zoom-image}
![](./assets/img/get-recipes-campbells-soup-970x250-call-to-action.png){.w-66 data-zoom-image}

## Rappel de principes

**Hiérarchie**

![](./assets/img/hierarchie-des-textes.png){data-zoom-image .w-100}
...
![](./assets/img/ads-formats-g.png){.w-20 data-zoom-image}
![](./assets/img/ads-formats-meta.png){.w-20 data-zoom-image}
![](./assets/img/ads-formats-li.png){.w-20 data-zoom-image}
![](./assets/img/ads-formats-x.png){.w-20 data-zoom-image}
...
![](./assets/img/gratuit-quote.gif){.w-50}
...
![](./assets/img/How-To-Maximize-the-Potential-of-Landing-Pages-Through-User-Behavior-Tracking-1.gif){data-zoom-image .w-100}

Chaque **action** ou **état** en ligne peut laisser une trace exploitable commercialement.

#### Cookies

![](./assets/img/cookie.gif){.w-25}
...
![](./assets/img/casino-oldpeople.gif){.w-25}
...
![](./assets/img/chou-fleur.gif){.w-25}

L’absence de fin de page retire le signal naturel d’arrêt.

#### Le biais de négativité

![](./assets/img/mental-health.gif){.w-25}
...
<div class="grid grid-1-2" markdown>
  ![](./activite/exercice/programme/preview.png)
