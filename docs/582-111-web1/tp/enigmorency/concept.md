...
**✅ Réponse** : <span class="spoiler">`the.html`</span>
</section>
</div>
...
**✅ Réponse** : <span class="spoiler">`chateau.html` (chat + eau)</span>
</div>
</div>
...
**✅ Réponse** : <span class="spoiler">`revolution-francaise.html` (« un veto corse la finira » est un anagramme de « révolution française »)</span>
</div>
</div>
...
**✅ Réponse** : <span class="spoiler">`1.html` (Cachée dans l'image, on peut voir la formule `(4 x 6 - 4) / 5 - 3`)</span>
</div>
</div>
...
**✅ Réponse** : <span class="spoiler">`aveugle.html` (Le trait du losange est écrit en code morse. Il est inscrit : « Je ne vois rien »)</span>
</div>
</div>
...
**✅ Réponse** : <span class="spoiler">`descartes.html`</span>
</div>
</div>
...
**✅ Réponse** : <span class="spoiler">`winehouse.html` (L'image donne 27. [Club des 27](https://fr.wikipedia.org/wiki/Club_des_27))</span>
</div>
</div>
...
**✅ Réponse** : <span class="spoiler">`5.html` (La somme de chaque ligne est le double de la précédente)</span>
</div>
</div>
