...
Cours 5 : Médias audio, vidéo et contenu structuré
	•	Audio (audio) et vidéo (video) : formats MP3, MP4, WebM, etc.
	•	Contrôles et attributs de médias
	•	Tableaux (table, tr, td, th, attributs colspan, rowspan)
	•	Listes structurées (ul, ol, dl, dt, dd)
	•	Atelier pratique : Page multimédia avec tableaux et listes
