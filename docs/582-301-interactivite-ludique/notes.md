...
https://www.youtube.com/watch?v=irMiPwLefwg
...
Nielsen’s usability heuristics (Nielsen 2005) 



Fondations théoriques (les plus citées)

Hunicke, LeBlanc & Zubek (2004), MDA : https://users.cs.northwestern.edu/~hunicke/MDA.pdf
Revue Game Studies : https://gamestudies.org/

Game User Experience Evaluation - Regina Bernhaupt https://d1wqtxts1xzle7.cloudfront.net/53319216/Game_User_Experience_Evaluation-libre.pdf

https://www.researchgate.net/profile/Yvonne-De-Kort/publication/226075575_Digital_Games_the_Aftermath_Qualitative_Insights_into_Postgame_Experiences/links/0deec52c81fba41ecf000000/Digital-Games-the-Aftermath-Qualitative-Insights-into-Postgame-Experiences.pdf#page=263


Salen & Zimmerman (2004), Rules of Play — LE manuel théorique
Juul (2005), Half-Real
Csikszentmihalyi (1990), Flow — base de presque toute la littérature UX de jeu
Malone (1980-81), travaux sur la motivation intrinsèque dans les jeux

Expérience joueur / UX (très cités)

Sweetser & Wyeth (2005), GameFlow — adaptation du flow au jeu, énormément citée
Ryan, Rigby & Przybylski (2006), modèle PENS (autodétermination appliquée au jeu)
Brown & Cairns (2004) et Ermi & Mäyrä (2005) sur l'immersion
IJsselsteijn et al., Game Experience Questionnaire (GEQ) — l'outil de mesure standard (malgré ses critiques)
Desurvire et al. (2004) et Pinelle et al. (2008) — heuristiques d'utilisabilité pour jeux

Typologies de joueurs

Bartle (1996), taxonomie des joueurs de MUD
Yee (2006), motivations des joueurs de MMO

Ouvrages de référence en pratique/recherche UX

Schell, The Art of Game Design (pédagogie universelle)
Fullerton, Game Design Workshop
Isbister & Schaffer (2008), Game Usability
Bernhaupt (dir.), Game User Experience Evaluation
Drachen, Mirza-Babaei & Nacke (2018), Games User Research — la bible du GUR moderne