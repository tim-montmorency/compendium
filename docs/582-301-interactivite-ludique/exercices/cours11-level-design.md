...
- [ ] **Le test du *Take*** : que se passe-t-il quand le joueur ramasse ta clé? Si la réponse est « rien », écris **une phrase** décrivant ce qui pourrait changer (une alarme, une porte qui se referme, la musique qui bascule). Une phrase, pas une implémentation
- [ ] **Quelle est la forme de ton niveau?** Couloir, place centrale ou boucle. Si c'est un couloir : où serait ta place centrale?
- [ ] Choisis **UN** principe de la capsule et applique-le maintenant (une lumière sur l'objectif, un landmark, un contraste sur ta clé, ton *Take*) - 15 minutes, pas plus : c'est un diagnostic, pas un chantier
