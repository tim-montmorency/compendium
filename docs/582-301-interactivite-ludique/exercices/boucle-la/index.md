...
- [ ] Ajoutez un prefab ETB ([Enhanced Trigger Box](https://assetstore.unity.com/packages/tools/game-toolkits/enhanced-trigger-box-72826)) à la fin du parcours pour interagir avec la sphère
