...
!!! warning "C'est un outil de **niveau**, pas de scénario"
    Le cercle décrit le **parcours du joueur dans l'espace**. Ce n'est pas une histoire à écrire, pas des dialogues à ajouter, pas des cinématiques. Rappel du piège 4 (cours 3) : l'histoire habille la boucle, elle ne la remplace pas. Ici, chaque temps du cercle est un **endroit** et une **action**.
...
* Ramasser la clé déclenche une **alarme** (son + lumière rouge : cours 7 et 11)
...
[Exercice - Diagnostic de level design et production :material-arrow-right:](./exercices/cours11-level-design.md){ .md-button .md-button--primary }
